...
gift.addEventListener('click', () => {
    ...
    gift.classList.toggle('dukdik', !open);
    giftTop.classList.toggle('boxOpen', open);
    giftBox.classList.toggle('boxDown', open);
    giftText.style.display = open ? 'block' : 'none';
